...
## Abstract {#abstract data-system-care-section="true" data-section-label="Abstract"}
...
## Introduction {#introduction data-system-care-section="true" data-section-label="Introduction"}
...
## Methods {#methods data-system-care-section="true" data-section-label="Methods"}
...
## Program description {#program-description data-system-care-section="true" data-section-label="Program description"}
...
## Program design {#program-design data-system-care-section="true" data-section-label="Program design"}
...
## Program assessment {#program-assessment data-system-care-section="true" data-section-label="Program assessment"}
...
## Challenges {#challenges data-system-care-section="true" data-section-label="Challenges"}
...
## Discussion {#discussion data-system-care-section="true" data-section-label="Discussion"}
...
## Conclusions {#conclusions data-system-care-section="true" data-section-label="Conclusions"}
...
## References {#references data-system-care-section="true" data-section-label="References"}
...
<script defer src="{{ '/assets/js/system-of-care-nav.js' | relative_url }}"></script>
