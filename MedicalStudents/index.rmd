...
Claudication refers to reproducible pain in a muscular territory of a limb following exertion. It is the limb equivalent of exertional angina. 
o	Claudication is NOT limb threatening. Patients with untreated claudication will only rarely develop the limb-threatening problems of rest pain or foot ulcers (rate of ~1-2% per year).
o	It is treated with exercise therapy and smoking cessation. Adherence to an exercise regimen can double pain-free walking distance. Exercise regimens have produced similar or better results than angioplasty and stenting in all seven randomized controlled trials that have been done in patients with intermittent claudication.
o	Intervention (surgery or endovascular therapy) is indicated only for patients who have adhered to an exercise regimen but have symptoms so severe that it impairs their work duties or activities of daily living.
o	Patients with intermittent claudication should receive optimal medical management to reduce their risk of cerebrovascular and coronary events. This generally includes the ABCDs: Aspirin, Blood Pressure Control, Cholesterol management, and a Diabetes regimen.
...
•	Measurement:
o	Measurement of the ankle pressures is done with a cuff at the ankle. A handheld Doppler probe is used to sequentially auscultate the dorsalis pedis and posterior tibial arteries. The systolic pressure at which an arterial waveform is heard is the pressure that is recorded. Ex. 110 mmHg for the posterior tibial artery and 60 mmHg for the dorsalis pedis artery.  
o	The higher of the two ankle pressures (dorsalis pedis or posterior tibial) is compared to the higher of the two arm pressures. The ratio is the ABI for the given extremity. Ex. 110 mmHg for the left posterior tibial artery [the higher of the two for the given extremity] divided by 130mmHg for the right brachial artery [which had been higher than the left brachial artery pressure] = left lower extremity ABI of 0.85.

•	Caveats in interpretation:
o	ABIs are typically not as informative as you might think in the setting of claudication or asymptomatic PAD. 
	There is not a great correlation between degree of symptoms and ABIs. Some younger, active patients may have very disabling symptoms with ABIs that are minimally-impaired or even normal at rest. Older, less active patients may have severely impaired ABIs with no or minimal symptoms.
	Although ABIs may help corroborate the presence of PAD, intermittent claudication can typically be diagnosed without ABI results.
	There are no indications to treat PAD simply based on ABI results (i.e. in absence of other symptoms or problems), regardless of how low they may be.
o	ABIs are notoriously unreliable in patient with diabetes mellitus.
	Calcification in the media of the arteries prevents adequate compression from the blood pressure cuff. ABIs >1.2 reflect noncompressible vessels and are therefore uninformative. However, even results in the normal range or below may be spuriously elevated because of this same process.
	The best non-invasive tests for degree of arterial perfusion in patients with diabetes are toe pressures, transcutaneous oximetry (TcPO2), or skin perfusion pressures. These tests assess blood flow in areas or via methods that are not typically affected by the same process of medial calcification. These methods also have much better reliability in predicting the likelihood of foot wound healing in patients with diabetes and foot wounds.
